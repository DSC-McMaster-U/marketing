  ...
  return (
    <>
      ...
      <header
        ...
        data-testid='header'
      >
        <div className='border-google-black bg-background/70 relative mx-auto flex h-12 max-w-7xl items-center justify-between gap-x-10 rounded-full border px-4 py-3 shadow-sm backdrop-blur-md sm:px-6 lg:px-8'>
          {/* Nav Menu */}
          <NavigationMenu>
