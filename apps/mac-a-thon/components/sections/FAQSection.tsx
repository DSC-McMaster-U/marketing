...
const FAQSection = async () => {
  ...
  return (
    <section
      id='faq'
      className='relative w-full max-w-none overflow-x-clip py-16 max-[400px]:min-h-[150vh] min-[400px]:max-md:min-h-[120vh] md:max-xl:min-h-[80vh] xl:aspect-[1440/1052]'
    >
