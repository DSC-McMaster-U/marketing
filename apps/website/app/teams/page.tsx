...
const TeamsOverview = () => {
  const getIcon = (id: string) => {
    switch (id) {
      ...
      case 'admin':
        return <FiBriefcase className='text-2xl' /> // Match Header.tsx
      default:
          ...
          <div className='flex w-full flex-col items-center'>
            <div className='flex max-w-2xl flex-col items-center justify-center gap-y-4 text-center'>
              ...
              <p className='text-lg text-neutral-600 dark:text-neutral-400'>
                GDG on Campus McMaster is made up of several specialized teams,
                each working on exciting initiatives. Click below to learn more
                about what we do!
              </p>
            </div>
          </div>
            ...
            {Object.values(teamsData).map((team) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`mt-4 w-fit rounded-full px-3 py-1 text-xs font-semibold uppercase bg-${team.color}/10 text-${team.color}`}
                  >
                    View Team &rarr;
                  </div>
                </Card>
